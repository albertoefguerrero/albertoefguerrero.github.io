...
|----------------------+------------------------+-----------------------------------|
|                      |                        | Jenkins and Docker Orchestration  |
|----------------------+------------------------+-----------------------------------|
|                      |                        | Docker !!                         |
|----------------------+------------------------+-----------------------------------|
| Secure Jenkins       |                        |                                   |
...
* Creating a custom Dockerfile with Jenkins, BlueOcean, Go and dependencies
#+begin_src Dockerfile
...
** TODO This will create a new Jenkins instance, we have to setup credentials again.
** TODO Crate an image out of custom image with all credentials

** TODO jenkins with docker https://medium.com/@karthi.net/docker-tutorial-build-docker-images-using-jenkins-d2880e65b74

** TODO Integrating SonarQube and Jenkins https://aspiresoftware.in/blog/intergrating-sonarqube-and-jenkins/
** TODO SonarScanner for Jenkins https://docs.sonarqube.org/latest/analysis/scan/sonarscanner-for-jenkins/
** TODO Try Out SonarQube https://docs.sonarqube.org/latest/setup/get-started-2-minutes/
** TODO Dockerhub - SonarQube https://hub.docker.com/_/sonarqube/
** TODO SonarQube - Docker installation https://techexpert.tips/sonarqube/sonarqube-docker-installation/
** TODO Prerequisites and Overview https://docs.sonarqube.org/latest/requirements/requirements/
